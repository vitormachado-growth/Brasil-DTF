...
import { ScrollTrigger } from "@/components/animation/gsap/register";
...
function ScrollController() {
  ...
  useEffect(() => {
    ...
    // Lenis animates the scroll position itself, so ScrollTrigger has to be
    // told when it moves. Left to native scroll events alone it reads a
    // position that lags behind the smoothed one, and triggers fire late.
